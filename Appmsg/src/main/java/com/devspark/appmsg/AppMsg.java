...
public class AppMsg {
    ...
    /**
     * Make a {@link com.devspark.appmsg.AppMsg} with a custom layout. The layout must have a {@link android.widget.TextView} com id {@link android.R.id.message}
     *
     * @param context The context to use. Usually your
     *                {@link android.app.Activity} object.
     * @param text    The text to show. Can be formatted text.
    ...
    /**
     * Make a non-floating {@link com.devspark.appmsg.AppMsg} with a custom view presented inside the layout.
    ...
    /**
     * Make a {@link com.devspark.appmsg.AppMsg} with a custom view. It can be used to create non-floating notifications if floating is false.
     *
     * @param context  The context to use. Usually your
     *                 {@link android.app.Activity} object.
     * @param view
    ...
    /**
     * Make a {@link com.devspark.appmsg.AppMsg} with a custom layout using the text from a
    ...
    /**
     * Cancels all queued {@link com.devspark.appmsg.AppMsg}s, in all Activities. If there is a {@link com.devspark.appmsg.AppMsg}
    ...
    /**
     * Cancels all queued {@link com.devspark.appmsg.AppMsg}s, in given {@link android.app.Activity}.
     * If there is a {@link com.devspark.appmsg.AppMsg} displayed currently, it will be the last one displayed.
     * @param activity
     */
