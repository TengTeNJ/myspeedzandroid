...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public static final String TAG = "MoTKAPP";
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        //mContext.getApplicationContext().finishActivity();
    }

    private void handleException() {
        View viewcontent = LayoutInflater.from(mContext).inflate
                (R.layout.dialog_appcrash, null);
        CustomDialog.Builder customBuilder = new
                CustomDialog.Builder(mContext);
        customBuilder.setContentView(viewcontent)
                .setNegativeButton(mContext.getString(R.string.confirm),
    ...
    private String saveCrashInfo2File(Throwable ex) {
        String path = SDCardRoot + "ruanyun/app/log/";
