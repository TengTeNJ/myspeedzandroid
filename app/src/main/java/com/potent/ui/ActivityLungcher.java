...
public class ActivityLungcher extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        .setCancelText(ActivityLungcher.this.getString(R.string.per_cancel) )
        .setConfirmText(ActivityLungcher.this.getString(R.string.sure) ));
        EasyPermission.build()
                .mRequestCode(MY_REQUEST_CODE)//请求code，自己定义
                .mPerms(permissions)//权限，可支持多个
                .mAlertInfo(new PermissionAlertInfo(ActivityLungcher.this.getString(R.string.per_title) ,
                        ActivityLungcher.this.getString(R.string.per_message) ))
            ...
            public void onPermissionsDismiss(int requestCode, @NonNull List<String> permissions) {
                ...
                Toast.makeText(ActivityLungcher.this, stringBuilder, Toast.LENGTH_LONG).show();
                finish();
            }
    ...
    private void gotoMain() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ActivityLungcher.this, ActivityMain.class));
                finish();
            }
        }, 1000);
    }
