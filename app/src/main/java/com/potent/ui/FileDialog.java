...
public class FileDialog extends ListActivity {
	...
	public static final int FILE_MODE_CREATE = 0;
	...
	private int selectionMode = FILE_MODE_CREATE;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		selectionMode = getIntent().getIntExtra(SELECTION_MODE,
				FILE_MODE_CREATE);
		if (selectionMode == FILE_MODE_OPEN) {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (file.isDirectory()) {
			...
			.setMessage("Send " + selectedFile.getPath() + " ?")
