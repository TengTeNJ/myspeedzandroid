        ...
        if (mDrawYValues && mCurrentData.getYValCount() < mMaxVisibleCount * mScaleX) {
            ...
            for (int i = 0; i < mCurrentData.getDataSetCount(); i++) {
                ...
                for (int j = 0; j < positions.length * mPhaseX; j += 2) {
                    ...
                    String formattedValue = mValueFormatter.getFormattedValue(val);
                    if (mDrawUnitInChart) {

                        String text = formattedValue + mUnit;
                        ...
                        String formattedValue1 = formattedValue;
                        mDrawCanvas.drawText(formattedValue1, positions[j],
